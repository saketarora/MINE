	...
	public static void testMirrorVerticalRightToLeft()
	  ...
	  public static void testMirrorGull() {
		...
		public static void encodeDecode(){
			Picture message = new Picture("crybytes-apple_icon.jpg");
			message.explore();
			Picture messagePict = new Picture("beach.jpg");
			messagePict.explore();
			messagePict.encode(message);
			messagePict.explore();
			
			Picture decoder = messagePict.decode();
			decoder.explore();
		}
